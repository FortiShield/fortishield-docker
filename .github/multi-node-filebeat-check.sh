filebeatout1=$(docker exec multi-node_fortishield.master_1 sh -c 'filebeat test output')
...
filebeatout2=$(docker exec multi-node_fortishield.worker_1 sh -c 'filebeat test output')
