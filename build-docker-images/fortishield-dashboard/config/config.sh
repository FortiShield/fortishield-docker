...
# Copy FortiShield dashboard certs to install config dir
cp /fortishield-certificates/demo.dashboard.pem ${CONFIG_DIR}/certs/dashboard.pem
cp /fortishield-certificates/demo.dashboard-key.pem ${CONFIG_DIR}/certs/dashboard-key.pem
cp /fortishield-certificates/root-ca.pem ${CONFIG_DIR}/certs/root-ca.pem
